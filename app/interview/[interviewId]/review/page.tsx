...
function QuestionResult({
  ...
  return (
    <div className={"rounded-lg bg-neutral-900 shadow-xl"}>
      <div className={"w-full p-2 bg-neutral-800 text-white rounded-t-lg px-3"}>
        <div>{index}번 질문</div>
      </div>
      <div className={"p-4 flex flex-col gap-2"}>
        <div>
          <div className={"text-sm text-neutral-200"}>점수</div>
          <div className={"text-lg font-semibold"}>{score}/5</div>
        </div>
        <div>
          <div className={"text-sm text-neutral-200"}>질문</div>
          <div className={"text-lg font-semibold"}>{question}</div>
        </div>
        <div>
          <div className={"text-sm text-neutral-200"}>답변</div>
          <div className={"text-lg font-semibold"}>{answer}</div>
        </div>
        <div
          className={"bg-orange-950 ring-2 mt-4 ring-orange-500 rounded-xl p-2"}
        >
          <div className={"text-sm text-neutral-200"}>피드백</div>
